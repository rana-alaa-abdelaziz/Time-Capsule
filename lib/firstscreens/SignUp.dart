                                    ...
                                    SizedBox(
                                      ...
                                      child: TextField(
                                        decoration: InputDecoration(
                                            ...
                                            prefixIcon: Icon(CupertinoIcons.mail,color:Color(0xFFDDCC8C))),
                                      ...
                                      child: TextField(
                                        decoration: InputDecoration(
                                          ...
                                          hintStyle: TextStyle(
                                              color:
                                                  Color(0xFFDDCC8C)),
                                          prefixIcon: Icon(CupertinoIcons.lock,color: Color(0xFFDDCC8C)),
                                          suffixIcon:
                                              Icon(CupertinoIcons.eye,color: Color(0xFFDDCC8C)),
                                        ),
